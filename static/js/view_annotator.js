  ...
  Annotator.Plugin.AnnotatorViewer = (function(_super) {
    ...
    */
    ...
    AnnotatorViewer.prototype.mascaraAnnotation = function(annotation) {
      ...
      $para = jQuery("span[id="+annotation.id+"]").closest("div").attr("number");
      if (!annotation.linespan) annotation.linespan = "Paragraph " + $para;
      ...
      annotation_layer += '<div class="anotador_text">'+  textAnnotation  + '</div></div><div class="annotator-marginviewer-date">'+ $.format.date(annotation.data_creacio, "dd/MM/yyyy HH:mm:ss") + '<span class="annotator-marginviewer-linespan">' + annotation.linespan + '</span></div><div class="annotator-marginviewer-quote">'+ annotation.quote + '</div><div class="annotator-marginviewer-footer"><span class="'+class_label+'">' + annotation.user + '</span>'+shared_annotation+delete_icon+'</div>';

      return annotation_layer;
    };

    AnnotatorViewer.prototype.createAnnotationPanel = function(annotation) {     
      var checboxes = '<input type="submit" value="Create Diagram ..." onclick="window.open(\'../diagram/index.html\',\'_blank\',\'resizable=yes\')"/><hr>';
